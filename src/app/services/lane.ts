...
export class Lane {
  ...
  crearLane(lane: LaneModel): Observable<ApiResponse<LaneModel>> { return this.http.post<ApiResponse<LaneModel>>(`${this.baseUrl}/procesos/${lane.proceso!.id!}/lanes`, lane); }
